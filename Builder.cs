...
namespace MMRando
{
    ...
    public class Builder
    {
        ...
        public void MakeROM(BinaryReader OldROM, string FileName, BackgroundWorker worker)
        {
            ...
            else
            {
                ...
                if (_settings.LogicMode != LogicMode.Vanilla)
                {
                    ...
                    //ResourceUtils.ApplyHack(Values.ModsDirectory + "permanent-razor-sword");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-2");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-3");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-4");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-5");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-6");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-7");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-8");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-9");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-10");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-11");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-12");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-13");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-14");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-15");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-16");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-17");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-18");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-19");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-20");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-21");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-22");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-23");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-24");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-25");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-26");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-27");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-28");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-29");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-30");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-31");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-32");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-33");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-34");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-35");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-36");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-37");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-38");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-39");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-40");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-41");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-42");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-43");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-44");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-45");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-46");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-47");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-48");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-49");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-50");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-51");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-52");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-53");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-54");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-55");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-56");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-57");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-58");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-59");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-60");
                    ResourceUtils.ApplyHack(Values.ModsDirectory + "misc-changes-61");
