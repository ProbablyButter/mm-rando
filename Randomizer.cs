...
ItemList[Items.ChestToIkanaGrotto].ReplacesItemId = Items.ChestBeanGrottoRedRupee;
...
ItemList[Items.MaskKamaro].ReplacesItemId = Items.ShopItemBombsBomb10;
...
ItemList[Items.BottleCatchPrincess].ReplacesItemId = Items.BottleCatchSpringWater;
...
ItemList[Items.HeartPieceDekuPlayground].ReplacesItemId = Items.MaskDeku;
ItemList[Items.MaskBremen].ReplacesItemId = Items.HeartPieceDekuPalace;
ItemList[Items.MaskDeku].ReplacesItemId = Items.HeartPieceDekuPlayground;
...
ItemList[Items.ChestInvertedStoneTowerSilverRupee].ReplacesItemId = Items.MaskDonGero;
ItemList[Items.TradeItemOceanDeed].ReplacesItemId = Items.ChestEastClockTownSilverRupee;
...
ItemList[Items.ChestIkanaGrottoBombchu5].ReplacesItemId = Items.HeartPieceEvan;
ItemList[Items.MaskBlast].ReplacesItemId = Items.ItemFireArrow;
...
ItemList[Items.ItemBottleBeavers].ReplacesItemId = Items.HeartContainerSnowhead;
ItemList[Items.SongSoaring].ReplacesItemId = Items.ItemGoldDust;
ItemList[Items.ShopItemWitchRedPotion].ReplacesItemId = Items.SongLullaby;
...
ItemList[Items.ChestTerminaGrottoBombchu].ReplacesItemId = Items.ItemGreatBayCompass;
...
ItemList[Items.MaskDonGero].ReplacesItemId = Items.ItemGreatBayMap;
ItemList[Items.ChestToGoronRaceGrotto].ReplacesItemId = Items.MaskGreatFairy;
ItemList[Items.ItemTingleMapStoneTower].ReplacesItemId = Items.ItemFairySword;
...
ItemList[Items.HeartPieceNotebookGran2].ReplacesItemId = Items.ChestIkanaGrottoBombchu5;
...
ItemList[Items.MaskGoron].ReplacesItemId = Items.MaskScents;
...
ItemList[Items.SongLullaby].ReplacesItemId = Items.ItemSnowheadCompass;
...
ItemList[Items.ChestGreatBayCapeGrotto].ReplacesItemId = Items.SongSoaring;
ItemList[Items.HeartContainerWoodfall].ReplacesItemId = Items.SongStorms;
ItemList[Items.ShopItemBombsBomb10].ReplacesItemId = Items.ChestSouthClockTownRedRupee;
...
ItemList[Items.UpgradeBiggestBombBag].ReplacesItemId = Items.HeartPieceTwinIslandsChest;
...
ItemList[Items.PreClocktownDekuNuts10].ReplacesItemId = Items.PreClocktownDekuNuts10;
ItemList[Items.TwinmoldTrialBombchu10].ReplacesItemId = Items.TwinmoldTrialBombchu10;
ItemList[Items.TwinmoldTrialArrows30].ReplacesItemId = Items.TwinmoldTrialArrows30;
      }
